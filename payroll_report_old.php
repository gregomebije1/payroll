...
if(isset($_REQUEST['action']) && ($_REQUEST['action'] =="Print")) {
  ...
  if (isset($_REQUEST['action']) && ($_REQUEST['action'] == 'Process')) {
    ...
    if (!isset($_REQUEST['bank_id'])) {
      echo msg_box('Please choose a Bank', 'process_payroll.php', 'Back');
      exit;
    }
	...
	<tr><td style='text-align:center;'>" 
	 ...
	 <tr><td style='text-align:center;'>BRANCH: " 
         . get_value('branch', 'name', 'id', $_REQUEST['branch_id'], $con)
         . "</td></tr>

	 <tr><td style='text-align:center;'>BANK: ";
	...
	foreach($employee as $employee_id => $employee_value) {
      ...
      if (mysqli_num_rows($result3) == 0) {
        echo msg_box("Payroll has not been prepared for this date for this Employee", "payroll_report.php", "Back");
        exit;
      }
